 ...
 * @author Windows
 */
public class ThongTinKhachHang_View extends javax.swing.JFrame {

    /**
     * Creates new form ThongTinKhachHang_View
     */
    public ThongTinKhachHang_View() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThongTinKhachHang_View.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ThongTinKhachHang_View().setVisible(true);
            }
        });
    }
